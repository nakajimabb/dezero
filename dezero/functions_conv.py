...
class Im2col(Function):
    def __init__(self, kernel_size, stride, pad, to_matrix):
        ...
        self.stride = stride
        self.pad = pad
        self.to_maxtrix = to_matrix

    def forward(self, x):
        self.input_shape = x.shape
        y = im2col_array(x, self.kernel_size, self.stride, self.pad, self.to_maxtrix)
        return y
